...
import (
	...
	msgsimulation "microservice/x/msg/simulation"
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&msgGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePost,
		msgsimulation.SimulateMsgCreatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgUpdatePost,
		msgsimulation.SimulateMsgUpdatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeletePost,
		msgsimulation.SimulateMsgDeletePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
